...
public class VaultBlockEntity extends BlockEntity implements MenuProvider {
    ...
    public VaultBlockEntity(BlockPos pPos, BlockState pBlockState) {
        super(ModBlockEntities.VAULT.get(), pPos, pBlockState);
    }
    ...
    public Component getDisplayName() {
        return Component.translatable("block.morecontainers.vault");
    }

    @Nullable
    @Override
    public AbstractContainerMenu createMenu(int pContainerId, Inventory pPlayerInventory, Player pPlayer) {
        return new VaultMenu(pContainerId, pPlayerInventory, this);
    }
}