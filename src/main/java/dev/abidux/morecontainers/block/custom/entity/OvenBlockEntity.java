...
public class OvenBlockEntity extends BlockEntity implements MenuProvider {
    ...
    public OvenBlockEntity(BlockPos pPos, BlockState pBlockState) {
        super(ModBlockEntities.OVEN.get(), pPos, pBlockState);
    }
    ...
    public Component getDisplayName() {
        return Component.translatable("block.morecontainers.oven");
    }

    @Nullable
    @Override
    public AbstractContainerMenu createMenu(int pContainerId, Inventory pPlayerInventory, Player pPlayer) {
        return new OvenMenu(pContainerId, pPlayerInventory, this);
    }
}