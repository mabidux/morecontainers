...
public class ToasterBlockEntity extends BlockEntity implements MenuProvider {
    ...
    public ToasterBlockEntity(BlockPos pPos, BlockState pBlockState) {
        super(ModBlockEntities.TOASTER.get(), pPos, pBlockState);
    }
    ...
    public Component getDisplayName() {
        return Component.translatable("block.morecontainers.toaster");
    }

    @Nullable
    @Override
    public AbstractContainerMenu createMenu(int pContainerId, Inventory pPlayerInventory, Player pPlayer) {
        return new ToasterMenu(pContainerId, pPlayerInventory, this);
    }
}